...
router.post("/:id/approve", requirePermission("expense", "approve"), approve);
router.post("/:id/finance-approve", requirePermission("expense", "finance_approve"), financeApprove);
router.post("/:id/mark-paid", requirePermission("expense", "finance_approve"), markPaid);
router.post("/:id/reject", requirePermission("expense", ["approve", "finance_approve"]), validate(rejectExpenseSchema), reject);
