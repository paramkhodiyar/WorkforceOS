    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-6 py-12 space-y-10">
        <div className="border-b border-slate-800 pb-6">
          ...
          <p className="text-slate-400 text-sm mt-2">Last updated: <strong className="text-slate-300">July 8, 2026</strong> &nbsp;|&nbsp; Governing law: India &nbsp;|&nbsp; Jurisdiction: Courts of India</p>
          <p className="text-slate-400 text-sm mt-3 leading-relaxed">
            These Terms of Service ("Terms") constitute a legally binding agreement between <strong className="text-white">WorkforceOS</strong> ("Provider",
            "we", "us") and the organization ("Client", "Data Fiduciary") subscribing to and using the WorkforceOS platform.
            By accessing or using the platform, you agree to be bound by these Terms.
          </p>
          <p className="text-amber-300 bg-amber-500/10 border border-amber-500/20 p-3 rounded-lg text-xs mt-3">
            ⚠️ If you are accessing WorkforceOS as an employee of a subscribing organization, your primary relationship is with your employer.
        ...
        <Section id="definitions" title="1. Definitions">
          <ul className="list-disc pl-5 space-y-1.5">
            <li><strong className="text-white">"Platform"</strong> — The WorkforceOS web application, mobile application, and API services.</li>
            <li><strong className="text-white">"Client"</strong> — The subscribing organization (company, firm, or entity) that has registered for the Platform.</li>
            <li><strong className="text-white">"User"</strong> — Any individual (employee, HR, admin) granted access by the Client.</li>
            <li><strong className="text-white">"Data Fiduciary"</strong> — The Client, as defined under the DPDP Act 2023, who determines the purpose and means of processing employee personal data.</li>
            <li><strong className="text-white">"Data Processor"</strong> — WorkforceOS, processing data on behalf of the Data Fiduciary.</li>
            <li><strong className="text-white">"Personal Data"</strong> — As defined under the Digital Personal Data Protection (DPDP) Act 2023.</li>
          </ul>
        </Section>
        ...
        <Section id="services" title="3. Scope of Services">
          ...
          <p>Features may change, be added, or discontinued. We will provide reasonable notice for material changes.</p>
        </Section>

        <Section id="data-responsibilities" title="4. Data Responsibilities">
          <h3 className="text-white font-semibold">Client Obligations (as Data Fiduciary)</h3>
          <ul className="list-disc pl-5 space-y-1.5">
          ...
          <h3 className="text-white font-semibold mt-3">WorkforceOS Obligations (as Data Processor)</h3>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <Section id="contact" title="12. Contact">
          <ul className="list-disc pl-5 space-y-1.5">
            <li><strong className="text-white">Email:</strong> legal@workforceos.com</li>
            <li><strong className="text-white">Grievance Officer (Privacy):</strong> privacy@workforceos.com</li>
          </ul>
        </Section>
        ...
        <div className="border-t border-slate-800 pt-6 text-center">
          ...
          <div className="flex justify-center gap-6 mt-3">
            <Link href="/privacy-policy" className="text-blue-400 hover:text-blue-300 text-xs underline">Privacy Policy</Link>
